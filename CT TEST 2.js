...
document.addEventListener('visibilitychange', function() {
  if (document.hidden) {
    clearInterval(timer); // Jeda timer ketika tab tidak aktif
  } else {
    timer = setInterval(updateTimer, 1000); // Lanjutkan timer ketika tab aktif
  }
});
...
var distance = countDown -= 5;

gotolink.html('<span class="bi bi-clock-fill"></span> Plase Wait...');
